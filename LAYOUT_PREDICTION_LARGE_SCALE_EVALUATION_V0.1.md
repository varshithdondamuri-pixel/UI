# Large-Scale Layout Prediction v0.2 Held-Out Evaluation Report
...
- **Overall Accuracy**: **97.50%** (Wilson 95% CI: [0.9697, 0.9794])
- **Macro F1**: **97.54%** (Wilson 95% CI: [0.9701, 0.9798])
- **Bootstrap Stability**: Mean Acc **97.50%**, StdDev **0.0035** (100 iterations, seed 42)
- **Generalization Scorecard**: **10/10 PASS** (Score: 100/100)
- **Approval Readiness**: `READY_FOR_REVIEW` (Evidence-Only)
...
- **Accuracy Wilson 95% CI**: [0.9697, 0.9794]
- **Macro F1 Wilson 95% CI**: [0.9701, 0.9798]
- **Bootstrap Iterations**: 100 iterations (seed 42)
- **Bootstrap Mean Accuracy**: 97.50%
- **Bootstrap StdDev**: 0.0035
- **Bootstrap 95% Percentile Range**: [97.00%, 98.00%]
